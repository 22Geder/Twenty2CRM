...
/**
 * סנכרון משרות בנק מזרחי טפחות - לפי מייל מ-25 בדצמבר 2025
 * מרביטל גרדי - revital.gardi@umtb.co.il
 */
...
// פונקציה ראשית
async function syncMizrahiPositions() {
...
${pos.jobType && pos.jobType.includes('משכנתאות') ? '\n📋 דרישות לבנקאי משכנתאות:\n• תואר פיננסי - חובה\n• יכולת מכירתית וניהול מו"מ\n• סדר וארגון' : ''}`,
      ...
      const icon = pos.isUrgent ? '🚨' : (pos.employmentType === 'קבוע' ? '✅' : pos.employmentType === 'חל"ד' ? '🔄' : '⏳');
