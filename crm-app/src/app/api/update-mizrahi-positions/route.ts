...
const ALL_POSITIONS: PositionData[] = [
  ...
  { title: 'טלר במרכז עסקים יהלומים בבורסה רמת גן - בנק מזרחי', location: 'רמת גן - הבורסה', region: 'מרחב מרכז', regionCode: 'JB-107', branchType: 'רצוף', employmentType: 'קבוע', additionalInfo: 'טלר יחיד בסניף, צריך מועמד שזמין לעבודה ללא אילוצים, יכולות גבוהות', salary: TELLER_SALARY_CONTINUOUS, bonus: TELLER_BONUS_REGULAR, keywords: TELLER_KEYWORDS, salaryRange: '8,200-9,500 ₪', employmentTypeField: 'משרה מלאה' },
  ...
  { title: 'בנקאי לסניף הפעילות הבינלאומית תל אביב - בנק מזרחי', location: 'תל אביב', region: 'מרחב מרכז', regionCode: 'JB-107', branchType: 'מפוצל ב\'-ו\'', employmentType: 'קבוע', additionalInfo: 'נדרש מועמד/ת עם שליטה בצרפתית, אנגלית ועברית', salary: BANKER_SALARY_SPLIT, bonus: null, keywords: INTERNATIONAL_KEYWORDS, salaryRange: '9,600-10,900 ₪', employmentTypeField: 'משרה מלאה', extraRequirements: '• שליטה בצרפתית - חובה\n• שליטה באנגלית - חובה\n• שליטה בעברית - חובה' },

  // ==================== מרחב דן JB-110 ====================
  { title: 'טלר בסניף חולון - בנק מזרחי', location: 'חולון', region: 'מרחב דן', regionCode: 'JB-110', branchType: 'מפוצל', employmentType: 'קבוע', additionalInfo: null, salary: TELLER_SALARY_SPLIT, bonus: TELLER_BONUS_REGULAR, keywords: TELLER_KEYWORDS, salaryRange: '9,300-10,700 ₪', employmentTypeField: 'משרה מלאה' },
  ...
  { title: 'בנקאי לקוחות בסניף מלכי ישראל ירושלים - בנק מזרחי', location: 'ירושלים - מלכי ישראל', region: 'מרחב יהודה', regionCode: 'JB-109', branchType: 'מפוצל', employmentType: 'קבוע', additionalInfo: null, salary: BANKER_SALARY_SPLIT, bonus: null, keywords: BANKER_KEYWORDS, salaryRange: '9,600-10,900 ₪', employmentTypeField: 'משרה מלאה' },
  { title: 'בנקאי לקוחות במרכז עסקים ירושלים - בנק מזרחי', location: 'ירושלים', region: 'מרחב יהודה', regionCode: 'JB-109', branchType: 'מפוצל', employmentType: 'חל"ד', additionalInfo: 'התפקיד כולל ביצוע פעולות בנקאיות ומתן שירותי מזכירות למנהל הסניף', salary: BANKER_SALARY_SPLIT, bonus: null, keywords: BANKER_KEYWORDS, salaryRange: '9,600-10,900 ₪', employmentTypeField: 'משרה מלאה' },
  // שפלת יהודה
  ...
  { title: 'בנקאי משכנתאות בסניף מודיעין - בנק מזרחי', location: 'מודיעין', region: 'מרחב יהודה', regionCode: 'JB-109', branchType: 'מפוצל ב\'-ו\'', employmentType: 'חל"ד', additionalInfo: 'החלפת חל"ד', salary: BANKER_SALARY_SPLIT, bonus: null, keywords: MORTGAGE_KEYWORDS, salaryRange: '9,600-10,900 ₪', employmentTypeField: 'משרה מלאה', extraRequirements: '• נדרש תואר פיננסי (כלכלה/מנה"ס)\n• ניסיון מכירתי ושירותי - חשוב מאוד\n• יכולת ניהול מו"מ גבוהה\n• סדר וארגון\n• יכולת אנליטית + ורבלית' },
  ...
  { title: 'טלר בסניף קרית אתא - בנק מזרחי', location: 'קרית אתא', region: 'מרחב צפון', regionCode: 'JB-113', branchType: 'מפוצל', employmentType: 'חל"ד', additionalInfo: 'החלפת חל"ד', salary: TELLER_SALARY_SPLIT, bonus: TELLER_BONUS_REGULAR, keywords: TELLER_KEYWORDS, salaryRange: '9,300-10,700 ₪', employmentTypeField: 'משרה מלאה' },
  ...
  { title: 'טלר בסניף באקה אל גרביה - בנק מזרחי', location: 'באקה אל גרביה', region: 'מרחב שרון', regionCode: 'JB-108', branchType: 'מפוצל', employmentType: 'חל"ד', additionalInfo: 'החלפת חל"ד', salary: TELLER_SALARY_SPLIT, bonus: TELLER_BONUS_REGULAR, keywords: TELLER_KEYWORDS, salaryRange: '9,300-10,700 ₪', employmentTypeField: 'משרה מלאה' },
