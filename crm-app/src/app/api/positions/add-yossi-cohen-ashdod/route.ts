...
/**
 * הוספת לקוח חדש: יוסי כהן (אשדוד) + 3 משרות
 *
...
const EMPLOYER_NAME = 'יוסי כהן - אשדוד'
const EMPLOYER_EMAIL = 'yossi.cohen.ashdod@twenty2crm.local'
...
// =============================================================
const DIAG_TITLE = 'מאבחן/ת רכב - אשדוד | שכר 15,000-20,000 ₪ תלוי בניסיון'
...
// =============================================================
const CLERK_TITLE = 'פקיד/ה - אשדוד | שכר 8,500-11,000 ₪'
...
// =============================================================
const MECH_TITLE = 'מכונאי/ת רכב - אשדוד | גם ללא ניסיון! (שכר לפי ניסיון)'
    ...
    if (!employer) {
      employer = await prisma.employer.create({
        data: {
          ...
          description: 'לקוח חדש: יוסי כהן - מוסך/עסק באשדוד',
        },
      })
