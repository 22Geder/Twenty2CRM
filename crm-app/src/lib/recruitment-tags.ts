...
export const RECRUITMENT_TAGS: RecruitmentTagsType = {
  ...
  "General_Office_Admin": {
    ...
    positive: [
      // מכירות - מילות בסיס
      "מכירות", "sales", "מכירה", "ניהול מכירות", "יעדי מכירות",
      // מכירות - צורות זכר ונקבה
      "איש מכירות", "אשת מכירות", "יועץ מכירות", "יועצת מכירות",
      "נציג מכירות", "נציגת מכירות", "מנהל מכירות", "מנהלת מכירות",
      "סוכן מכירות", "סוכנת מכירות", "מוקדן מכירות", "מוקדנית מכירות",
      // מכירות - סוגים
      ...
      "מכירות ציוד", "מכירות תעשייה", "מכירות שטח", "מכירות טלפוניות",
      // כללי משרד ואדמיניסטרציה
      "ERP", "ISO 9001", "Microsoft Office", "SAP", "אדמיניסטרציה",
      "אחזקת מתקנים", "בק אופיס", "Back Office",
      "הנדסת תעשיה וניהול", "כושר סדר וארגון",
      "מוקדן", "מוקדנית", "מזכירה", "מזכירה רפואית", "מנהל אזור", "מנהל ייצור",
      "מנהל לוגיסטיקה", "מנהל מחלקה", "מנהל משרד",
  ...
  "Vehicle_Automotive": {
    ...
    positive: [
      // 🆕 מילים בודדות חשובות!
      "רכב", "רכבים", "אוטו", "מכונית", "מכוניות", "אוטומוטיב", "automotive",
      
      // 🆕 לימודים והשכלה ברכב
      "לימודי רכב", "לומד רכב", "הנדסת רכב", "הנדסאי רכב", "מכללת רכב",
      "קורס רכב", "הכשרה ברכב", "הסמכה ברכב", "תעודת רכב", "מקצוע רכב",
      "לימודים ברכב", "מגמת רכב", "התמחות ברכב", "אוטוטרוניקה",
      ...
      // מאבחנים ודיאגנוסטיקה - חשוב!
      "מאבחן", "מאבחן רכב", "דיאגנוסטיקה", "אבחון", "אבחון תקלות",
      "טכנאי רכב", "חשמל רכב", "אוטוטרוניקה", "הנדסאי רכב",
      "PDI", "בקר רכב", "תקלות רכב", "טיפולי רכב", "ראש צוות חשמל",
      "מנהל חשמל", "חשמל ודיאגנוסטיקה", "מחשבי דיאגנוסטיקה",
      "אנגלית טכנית", "הכנה למסירה", "מכשירי אבחון",
