...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-600 via-orange-500 to-orange-600 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-orange-100 text-lg">מערכת ניהול גיוס מתקדמת</p>
        </div>
