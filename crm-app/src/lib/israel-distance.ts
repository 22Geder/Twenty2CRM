...
const CITY_COORDS: Record<string, [number, number]> = {
  ...
  // גוש עציון
  'אפרת': [31.6553, 35.1493],
  'גוש עציון': [31.6553, 35.1493],

  // אזור נמל תעופה בן גוריון
  'אירפורט סיטי': [32.0072, 34.8820],
  'קרית שדה התעופה': [32.0072, 34.8820],
  'airport city': [32.0072, 34.8820],

  // ערים נוספות
  'קריית עקרון': [31.8635, 34.8060],
  'קרית עקרון': [31.8635, 34.8060],
  'כפר כנא': [32.7450, 35.3370],
  'כפר מנדא': [32.8100, 35.2540],
  'כפר חב"ד': [31.9640, 34.8860],
  'חשמונאים': [31.9490, 34.9990],
  'אבו גוש': [31.8090, 35.1070],
  'עינת': [32.0380, 34.9340],
  'כוכב יאיר': [32.2300, 34.9820],
  'צור יגאל': [32.2300, 34.9820],
  'רהט': [31.3926, 34.7540],
  'חורה': [31.2676, 34.9230],
  'לקיה': [31.3637, 34.6940],
  'כסיפה': [31.2250, 34.9890],
  'שגב שלום': [31.1710, 34.8650],
  'תל שבע': [31.2450, 34.9740],
  'ערערה בנגב': [31.2750, 34.8220],
  'פוריידיס': [32.6050, 34.9410],
  'ג\'סר א-זרקא': [32.5370, 34.9150],

  // ישובים קטנים, מושבים ואזורי תעשייה – מרחק 20 ק"מ
  'בילו': [31.867, 34.800],               // מרכז קניות בילו / צומת בילו (ליד רחובות/יבנה)
  'מרכז בילו': [31.867, 34.800],
  'שילת': [31.933, 34.990],               // מושב שילת (ליד מודיעין/לוד)
  'עין שמר': [32.480, 34.950],            // מושב עין שמר (ליד חדרה/פרדס חנה)
  'מבקיעים': [31.764, 34.628],            // קיבוץ מבקיעים (חוף דרום-אשדוד/אשקלון)
  'באר טוביה': [31.733, 34.750],          // מושב באר טוביה (ליד קריית מלאכי)
  'סינרמה': [32.005, 34.882],             // סינמה סיטי (אזור אירפורט סיטי / בן גוריון)
  '601': [31.775, 34.665],                 // אזור מחסנים 601 (דרום אשדוד/שפלה)
  'ספץ': [31.800, 34.650],                // ספץ לוגיסטיקה, אשדוד
}
