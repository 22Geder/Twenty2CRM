...
const EXTENDED_KEYWORDS: Record<string, string[]> = {
  ...
  // רכב ומכירות רכב - 50+ מילים
  automotive: [
    'רכב', 'רכבים', 'מכירות רכב', 'סוכן רכב', 'איש מכירות רכב',
    'אולם תצוגה', 'showroom', 'סוכנות רכב', 'יבואן רכב', 'car sales',
    'טרייד אין', 'טריידאין', 'trade in', 'יד ראשונה', 'יד שניה', 'יד 2',
    'מימון רכב', 'ליסינג', 'leasing', 'ביטוח רכב', 'insurance',
    'מסירת רכב', 'PDI', 'הכנה למסירה', 'בדיקת רכב', 'רישוי',
    'טויוטה', 'לקסוס', 'מאזדה', 'יונדאי', 'קיה', 'ניסאן', 'הונדה',
    'GEELY', 'ג\'ילי', 'ZEEKR', 'זיקר', 'BMW', 'מרצדס', 'אאודי',
    'פולקסווגן', 'סקודה', 'רנו', 'פיאט', 'שברולט', 'סובארו',
    'אלבר', 'סאן קאר', 'באדג\'ט', 'Budget', 'UNION', 'יוניון',
    'דלק מוטורס', 'קרסו מוטורס', 'UMI', 'יוניברסל מוטורס',
    'פריים מוטורס', 'אופרייט', 'Upright', 'אוטומוביל', 'אוטוקאר',
    'סלקט', 'select', 'חברת ליסינג', 'השכרת רכב', 'rent a car',
    'יועץ שירות', 'שירות רכב', 'מוסך', 'מכונאי רכב', 'חשמלאי רכב',
    'בוחן רכב', 'מאבחן תקלות', 'פחח', 'צבעי רכב', 'אביזרי רכב',
    'מתקין אביזרים', 'רפרנט תפעול', 'תומך טכני', 'נסיעות התרשמות',
    'test drive', 'נסיעת מבחן', 'דייל קבלה רכב', 'נציג קבלה רכב',
    'מנהל אולם תצוגה', 'מנהל סניף רכב', 'מתאם מכירות',
    'גיוס לקוחות רכב', 'תיק לקוחות רכב', 'סוכן שטח רכב',
    'מגזר עסקי רכב', 'לקוחות עסקיים', 'פיתוח עסקי רכב'
  ]
};
...
- אם האדם עבד בעולם הרכב (אלבר, סאן קאר, באדג'ט, יד ראשונה, סוכנות רכב, טרייד אין, ליסינג, אולם תצוגה, מכירות רכב) - הוסף "רכב", "מכירות רכב", "עולם הרכב"
- אם האדם היה סוכן שטח או איש מכירות שטח - הוסף "סוכן שטח", "מכירות שטח"
