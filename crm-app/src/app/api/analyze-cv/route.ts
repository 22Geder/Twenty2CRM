...
const EXTENDED_KEYWORDS: Record<string, string[]> = {
  ...
  // רכב/אוטומוטיב - 70+ מילים - כולל מאבחנים וטכנאים!
  automotive: [
    // בסיסי רכב ומכירות
    ...
    'מאבחן', 'מאבחן רכב', 'מאבחן תקלות', 'דיאגנוסטיקה', 'אבחון', 'אבחון תקלות',
    'חשמלאי רכב', 'טכנאי רכב', 'חשמל רכב', 'אוטוטרוניקה', 'הנדסאי רכב',
    'PDI', 'בוחן רכב', 'בקר רכב', 'תקלות', 'טיפולי רכב', 'מכונאי רכב',
    'ראש צוות חשמל', 'מנהל חשמל', 'תומך טכני', 'הכנה למסירה',
    // מותגים
  ...
  // NOTE: automotive is already defined above, so we don't duplicate it here
};
